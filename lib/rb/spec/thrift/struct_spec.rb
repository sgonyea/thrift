  ...
  describe "ThriftStructSpec" do
    ...
    describe ::Thrift::Struct do
      ...
      it "should support optional type-checking in Thrift::Struct.new" do
        ...
        begin
          lambda { Hello.new(:greeting => 3) }.should raise_error(Thrift::TypeError, "Expected Types::STRING, received Fixnum for field greeting")
        ensure
          Thrift.type_checking = false
        end
        lambda { Hello.new(:greeting => 3) }.should_not raise_error(Thrift::TypeError)
      end
      ...
      it "should raise an exception when unknown types are given to Thrift::Struct.new" do
        lambda { Hello.new(:fish => 'salmon') }.should raise_error(Thrift::Exception, "Unknown key given to SpecNamespace::Hello.new: fish")
      end
